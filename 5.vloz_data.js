...
var mov1 = db.movies.insertOne({"averageRating": 6.6, "director": dir1, "releaseDate": new Date(2009-06-01), "title": "adipiscing"}).insertedId;
var mov2 = db.movies.insertOne({"averageRating": 6.7, "director": dir1, "releaseDate": new Date(2013-07-16), "title": "aliquam adipiscing"}).insertedId;
var mov3 = db.movies.insertOne({"averageRating": 5.4, "director": dir1, "releaseDate": new Date(1980-06-14), "title": "Proin"}).insertedId;
var mov4 = db.movies.insertOne({"averageRating": 6.1, "director": dir1, "releaseDate": new Date(2000-03-08), "title": "blandit at,"}).insertedId;
var mov5 = db.movies.insertOne({"averageRating": 3.3, "director": dir2, "releaseDate": new Date(1975-09-06), "title": "sed pede."}).insertedId;
